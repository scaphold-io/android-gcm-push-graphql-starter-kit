...
public class MessageReceivingService extends Service{
    ...
    public static void sendToApp(Bundle extras, Context context){
        ...
        newIntent.setClass(context, ScapholdPushTutorial.class);
    ...
    public void onCreate(){
        ...
        // Let ScapholdPushTutorial know we have just initialized and there may be stored messages
    ...
    protected static void saveToLog(Bundle extras, Context context){
        ...
        editor.commit();
        postNotification(new Intent(context, ScapholdPushTutorial.class), context);
    }
